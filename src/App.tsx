...
import './App.css';
import image from './assets/SC50150.jpg';
    ...
    <div>
      <Row>
        ...
        <Col md={12} className="align-self-center pt-3 pt-md-0 pb-3 pb-md-0 mt-md-5 pr-0 pl-0">
          ...
          <div>
            <a href="mailto:leeroy.wack@gmail.com" target="_blank" rel="noopener noreferrer">
              <Button variant="secondary">leeroy.wack@gmail.com</Button>
            </a>
          </div>
        </Col>
      </Row>
